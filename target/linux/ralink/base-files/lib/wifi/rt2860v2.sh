...
detect_rt2860v2() {
	...
	cd /sys/module/
		[ -d rt2860v2_ap ] || [ -d mt76x2e ] || [ -d mt76x2_ap ] || [ -d mt7603e ] || [ -d mt7603_ap ] || [ -d mt7628 ]  || return
	...
	[ -f /etc/Wireless/RT2860/RT2860.dat ] || {
	  ...
	  ln -s $CFG_FILES_1ST /etc/Wireless/RT2860/RT2860AP.dat 2>/dev/null
	}
...
config wifi-iface
	...
	option mode		ap
	option wps		none
	option ssid		PandoraBox_$(echo $(rt2860v2_get_first_if_mac Factory) | awk -F ":" '{print $4""$5""$6 }'| tr a-z A-Z)
