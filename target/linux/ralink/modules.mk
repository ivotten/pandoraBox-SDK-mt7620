...
#
define KernelPackage/ralink-i2s-pcm
#   SUBMENU:=Ralink Drivers
  TITLE:=Ralink MT762x I2S/PCM Audio Driver
  DEPENDS:=@TARGET_ralink +kmod-sound-soc-core +kmod-regmap +kmod-ralink-i2c
  KCONFIG:= \
  ...
  AUTOLOAD:=$(call AutoLoad,66,snd-soc-mt76xx-i2s-ctl \
		snd-soc-mt76xx-pcm snd-soc-mt76xx-i2s i2c_wm8960 snd-soc-wm8960  \
		 snd-soc-mt76xx-machine \
  )
  $(call AddDepends/sound)
endef

define KernelPackage/ralink-i2s-pcm/description
  This package for Ralink I2S/PCM Audio Drivers.
endef

$(eval $(call KernelPackage,ralink-i2s-pcm))
