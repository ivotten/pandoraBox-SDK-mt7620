...
$(eval $(call SetupHostCommand,ocamlc,Please install the Objective Caml compiler (ocaml-nox) v3.11 or later, \
	ocamlc -v | grep version | awk '($$$$$$$$5 >= "3.11") { print "ok" }' | grep ok ))
