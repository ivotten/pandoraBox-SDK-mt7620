...
#define TASK_MM 336 /* offsetof(struct task_struct, mm)	 # */
#define TASK_PID 392 /* offsetof(struct task_struct, pid)	 # */
#define TASK_STACK_CANARY 400 /* offsetof(struct task_struct, stack_canary)	 # */
#define TASK_STRUCT_SIZE 1408 /* sizeof(struct task_struct)	 # */
...
#define THREAD_REG16 656 /* offsetof(struct task_struct, thread.reg16)	 # */
#define THREAD_REG17 660 /* offsetof(struct task_struct, thread.reg17)	 # */
#define THREAD_REG18 664 /* offsetof(struct task_struct, thread.reg18)	 # */
#define THREAD_REG19 668 /* offsetof(struct task_struct, thread.reg19)	 # */
#define THREAD_REG20 672 /* offsetof(struct task_struct, thread.reg20)	 # */
#define THREAD_REG21 676 /* offsetof(struct task_struct, thread.reg21)	 # */
#define THREAD_REG22 680 /* offsetof(struct task_struct, thread.reg22)	 # */
#define THREAD_REG23 684 /* offsetof(struct task_struct, thread.reg23)	 # */
#define THREAD_REG29 688 /* offsetof(struct task_struct, thread.reg29)	 # */
#define THREAD_REG30 692 /* offsetof(struct task_struct, thread.reg30)	 # */
#define THREAD_REG31 696 /* offsetof(struct task_struct, thread.reg31)	 # */
#define THREAD_STATUS 700 /* offsetof(struct task_struct, thread.cp0_status)	 # */
#define THREAD_FPU 704 /* offsetof(struct task_struct, thread.fpu)	 # */
#define THREAD_BVADDR 1020 /* offsetof(struct task_struct, thread.cp0_badvaddr)	 # */
#define THREAD_BUADDR 1024 /* offsetof(struct task_struct, thread.cp0_baduaddr)	 # */
#define THREAD_ECODE 1028 /* offsetof(struct task_struct, thread.error_code)	 # */

#define THREAD_FPR0 704 /* offsetof(struct task_struct, thread.fpu.fpr[0])	 # */
#define THREAD_FPR1 712 /* offsetof(struct task_struct, thread.fpu.fpr[1])	 # */
#define THREAD_FPR2 720 /* offsetof(struct task_struct, thread.fpu.fpr[2])	 # */
#define THREAD_FPR3 728 /* offsetof(struct task_struct, thread.fpu.fpr[3])	 # */
#define THREAD_FPR4 736 /* offsetof(struct task_struct, thread.fpu.fpr[4])	 # */
#define THREAD_FPR5 744 /* offsetof(struct task_struct, thread.fpu.fpr[5])	 # */
#define THREAD_FPR6 752 /* offsetof(struct task_struct, thread.fpu.fpr[6])	 # */
#define THREAD_FPR7 760 /* offsetof(struct task_struct, thread.fpu.fpr[7])	 # */
#define THREAD_FPR8 768 /* offsetof(struct task_struct, thread.fpu.fpr[8])	 # */
#define THREAD_FPR9 776 /* offsetof(struct task_struct, thread.fpu.fpr[9])	 # */
#define THREAD_FPR10 784 /* offsetof(struct task_struct, thread.fpu.fpr[10])	 # */
#define THREAD_FPR11 792 /* offsetof(struct task_struct, thread.fpu.fpr[11])	 # */
#define THREAD_FPR12 800 /* offsetof(struct task_struct, thread.fpu.fpr[12])	 # */
#define THREAD_FPR13 808 /* offsetof(struct task_struct, thread.fpu.fpr[13])	 # */
#define THREAD_FPR14 816 /* offsetof(struct task_struct, thread.fpu.fpr[14])	 # */
#define THREAD_FPR15 824 /* offsetof(struct task_struct, thread.fpu.fpr[15])	 # */
#define THREAD_FPR16 832 /* offsetof(struct task_struct, thread.fpu.fpr[16])	 # */
#define THREAD_FPR17 840 /* offsetof(struct task_struct, thread.fpu.fpr[17])	 # */
#define THREAD_FPR18 848 /* offsetof(struct task_struct, thread.fpu.fpr[18])	 # */
#define THREAD_FPR19 856 /* offsetof(struct task_struct, thread.fpu.fpr[19])	 # */
#define THREAD_FPR20 864 /* offsetof(struct task_struct, thread.fpu.fpr[20])	 # */
#define THREAD_FPR21 872 /* offsetof(struct task_struct, thread.fpu.fpr[21])	 # */
#define THREAD_FPR22 880 /* offsetof(struct task_struct, thread.fpu.fpr[22])	 # */
#define THREAD_FPR23 888 /* offsetof(struct task_struct, thread.fpu.fpr[23])	 # */
#define THREAD_FPR24 896 /* offsetof(struct task_struct, thread.fpu.fpr[24])	 # */
#define THREAD_FPR25 904 /* offsetof(struct task_struct, thread.fpu.fpr[25])	 # */
#define THREAD_FPR26 912 /* offsetof(struct task_struct, thread.fpu.fpr[26])	 # */
#define THREAD_FPR27 920 /* offsetof(struct task_struct, thread.fpu.fpr[27])	 # */
#define THREAD_FPR28 928 /* offsetof(struct task_struct, thread.fpu.fpr[28])	 # */
#define THREAD_FPR29 936 /* offsetof(struct task_struct, thread.fpu.fpr[29])	 # */
#define THREAD_FPR30 944 /* offsetof(struct task_struct, thread.fpu.fpr[30])	 # */
#define THREAD_FPR31 952 /* offsetof(struct task_struct, thread.fpu.fpr[31])	 # */
#define THREAD_FCR31 960 /* offsetof(struct task_struct, thread.fpu.fcr31)	 # */
...
#define VCPU_ARCH_SIZE 2304 /* sizeof(struct kvm_vcpu_arch)	 # */
...
#define VCPU_GUEST_KERNEL_ASID 1508 /* offsetof(struct kvm_vcpu_arch, guest_kernel_asid)	 # */
