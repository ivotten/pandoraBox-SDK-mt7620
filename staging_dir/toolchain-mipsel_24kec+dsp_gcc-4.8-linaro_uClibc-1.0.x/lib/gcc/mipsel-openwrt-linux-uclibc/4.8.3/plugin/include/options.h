...
enum opt_code
{
  ...
  OPT_Werror_maybe_reset = 220,              /* -Werror-maybe-reset */
  ...
  OPT_fextended_identifiers = 587,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 588,                /* -fextern-tls-init */
  OPT_fexternal_blas = 589,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 590, */       /* -fexternal-templates */
  OPT_ff2c = 591,                            /* -ff2c */
  OPT_ffast_math = 592,                      /* -ffast-math */
  OPT_ffat_lto_objects = 593,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 594,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 595,               /* -ffinite-math-only */
  OPT_ffix_bdsl = 596,                       /* -ffix-bdsl */
  ...
  OPT_fhonour_copts = 642,                   /* -fhonour-copts */
  ...
  OPT_floop_block = 700,                     /* -floop-block */
  /* OPT_floop_flatten = 701, */             /* -floop-flatten */
  OPT_floop_interchange = 702,               /* -floop-interchange */
  OPT_floop_nest_optimize = 703,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 704, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 705,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 706,                /* -floop-strip-mine */
  OPT_flto = 707,                            /* -flto */
  OPT_flto_compression_level_ = 708,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 709,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 710,         /* -flto-partition=balanced */
  OPT_flto_partition_max = 711,              /* -flto-partition=max */
  OPT_flto_partition_none = 712,             /* -flto-partition=none */
  OPT_flto_report = 713,                     /* -flto-report */
  OPT_flto_ = 714,                           /* -flto= */
  OPT_fltrans = 715,                         /* -fltrans */
  OPT_fltrans_output_list_ = 716,            /* -fltrans-output-list= */
  OPT_fmain_ = 717,                          /* -fmain= */
  OPT_fmath_errno = 718,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 719,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 720,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 721,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 722,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 723,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 724,                     /* -fmem-report */
  OPT_fmem_report_wpa = 725,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 726,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 727,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 728,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 729,                /* -fmessage-length= */
  OPT_fmodule_private = 730,                 /* -fmodule-private */
  OPT_fmodulo_sched = 731,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 732,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 733,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 734,                  /* -fms-extensions */
  OPT_fmudflap = 735,                        /* -fmudflap */
  OPT_fmudflapir = 736,                      /* -fmudflapir */
  OPT_fmudflapth = 737,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 738, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 739, */                  /* -fnew-abi */
  OPT_fnext_runtime = 740,                   /* -fnext-runtime */
  OPT_fnil_receivers = 741,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 742, */       /* -fno-vect-cost-model */
  ...
  OPT_fuse_cxa_atexit = 974,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 975,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 976,          /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 977,                     /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 978,                    /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 979,              /* -fuse-linker-plugin */
  OPT_fuse_tls = 980,                        /* -fuse-tls */
  ...
  OPT_fvect_cost_model_ = 987,               /* -fvect-cost-model= */
  OPT_fverbose_asm = 988,                    /* -fverbose-asm */
  /* OPT_fversion = 989, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 990,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 991,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 992,                    /* -fvisibility= */
  OPT_fvpt = 993,                            /* -fvpt */
  /* OPT_fvtable_gc = 994, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 995, */            /* -fvtable-thunks */
  OPT_fweak = 996,                           /* -fweak */
  OPT_fweb = 997,                            /* -fweb */
  OPT_fwhole_file = 998,                     /* -fwhole-file */
  OPT_fwhole_program = 999,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1000,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1001,             /* -fworking-directory */
  OPT_fwpa = 1002,                           /* -fwpa */
  OPT_fwrapv = 1003,                         /* -fwrapv */
  /* OPT_fxref = 1004, */                    /* -fxref */
  /* OPT_fzee = 1005, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1006,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1007,                     /* -fzero-link */
  OPT_g = 1008,                              /* -g */
  OPT_gant = 1009,                           /* -gant */
  OPT_gcoff = 1010,                          /* -gcoff */
  OPT_gdwarf_ = 1011,                        /* -gdwarf- */
  OPT_gen_decls = 1012,                      /* -gen-decls */
  OPT_ggdb = 1013,                           /* -ggdb */
  OPT_gnat = 1014,                           /* -gnat */
  OPT_gnatO = 1015,                          /* -gnatO */
  OPT_gno_pubnames = 1016,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1017,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1018,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1019,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1020,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1021,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1022,                   /* -gsplit-dwarf */
  OPT_gstabs = 1023,                         /* -gstabs */
  OPT_gstabs_ = 1024,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1025,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1026,                        /* -gtoggle */
  OPT_gvms = 1027,                           /* -gvms */
  OPT_gxcoff = 1028,                         /* -gxcoff */
  OPT_gxcoff_ = 1029,                        /* -gxcoff+ */
  OPT_h = 1030,                              /* -h */
  OPT_idirafter = 1031,                      /* -idirafter */
  OPT_imacros = 1032,                        /* -imacros */
  OPT_imultiarch = 1033,                     /* -imultiarch */
  OPT_imultilib = 1034,                      /* -imultilib */
  OPT_include = 1035,                        /* -include */
  OPT_iplugindir_ = 1036,                    /* -iplugindir= */
  OPT_iprefix = 1037,                        /* -iprefix */
  OPT_iquote = 1038,                         /* -iquote */
  OPT_isysroot = 1039,                       /* -isysroot */
  OPT_isystem = 1040,                        /* -isystem */
  OPT_iwithprefix = 1041,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1042,              /* -iwithprefixbefore */
  OPT_k8 = 1043,                             /* -k8 */
  OPT_l = 1044,                              /* -l */
  OPT_lang_asm = 1045,                       /* -lang-asm */
  OPT_mabi_ = 1046,                          /* -mabi= */
  OPT_mabicalls = 1047,                      /* -mabicalls */
  OPT_mandroid = 1048,                       /* -mandroid */
  OPT_march_ = 1049,                         /* -march= */
  OPT_mbionic = 1050,                        /* -mbionic */
  OPT_mbranch_cost_ = 1051,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1052,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1053,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1054,                /* -mcode-readable= */
  ...
  OPT_mexplicit_relocs = 1066,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1067,                  /* -mextern-sdata */
  OPT_mfix_24k = 1068,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1069,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1070,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1071,                     /* -mfix-r4400 */
  OPT_mfix_sb1 = 1072,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1073,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1074,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1075,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1076,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1077,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1078,                 /* -mfp-exceptions */
  OPT_mfp32 = 1079,                          /* -mfp32 */
  OPT_mfp64 = 1080,                          /* -mfp64 */
  OPT_mfused_madd = 1081,                    /* -mfused-madd */
  OPT_mglibc = 1082,                         /* -mglibc */
  OPT_mgp32 = 1083,                          /* -mgp32 */
  OPT_mgp64 = 1084,                          /* -mgp64 */
  OPT_mgpopt = 1085,                         /* -mgpopt */
  OPT_mhard_float = 1086,                    /* -mhard-float */
  OPT_minterlink_mips16 = 1087,              /* -minterlink-mips16 */
  OPT_mips = 1088,                           /* -mips */
  OPT_mips16 = 1089,                         /* -mips16 */
  OPT_mips3d = 1090,                         /* -mips3d */
  OPT_mllsc = 1091,                          /* -mllsc */
  OPT_mlocal_sdata = 1092,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1093,                    /* -mlong-calls */
  OPT_mlong32 = 1094,                        /* -mlong32 */
  OPT_mlong64 = 1095,                        /* -mlong64 */
  OPT_mmad = 1096,                           /* -mmad */
  OPT_mmcount_ra_address = 1097,             /* -mmcount-ra-address */
  OPT_mmcu = 1098,                           /* -mmcu */
  OPT_mmemcpy = 1099,                        /* -mmemcpy */
  OPT_mmt = 1100,                            /* -mmt */
  OPT_mmusl = 1101,                          /* -mmusl */
  OPT_mno_float = 1102,                      /* -mno-float */
  OPT_mno_flush_func = 1103,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1104,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1105,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1106,                     /* -mno-mips3d */
  OPT_mpaired_single = 1107,                 /* -mpaired-single */
  OPT_mplt = 1108,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1109,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1110,               /* -mrelax-pic-calls */
  OPT_mshared = 1111,                        /* -mshared */
  OPT_msingle_float = 1112,                  /* -msingle-float */
  OPT_msmartmips = 1113,                     /* -msmartmips */
  OPT_msoft_float = 1114,                    /* -msoft-float */
  OPT_msplit_addresses = 1115,               /* -msplit-addresses */
  OPT_msym32 = 1116,                         /* -msym32 */
  OPT_msynci = 1117,                         /* -msynci */
  OPT_mtune_ = 1118,                         /* -mtune= */
  OPT_muclibc = 1119,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1120,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1121,                  /* -mvr4130-align */
  OPT_mxgot = 1122,                          /* -mxgot */
  OPT_n = 1123,                              /* -n */
  OPT_no_canonical_prefixes = 1124,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1125,              /* -no-integrated-cpp */
  OPT_noasmopt = 1126,                       /* -noasmopt */
  OPT_nocpp = 1127,                          /* -nocpp */
  ...
  OPT_profile = 1153,                        /* -profile */
  OPT_pthread = 1154,                        /* -pthread */
  OPT_quiet = 1155,                          /* -quiet */
  OPT_r = 1156,                              /* -r */
  OPT_rdynamic = 1157,                       /* -rdynamic */
  OPT_remap = 1158,                          /* -remap */
  OPT_s = 1159,                              /* -s */
  OPT_s_bc_abi = 1160,                       /* -s-bc-abi */
  OPT_save_temps = 1161,                     /* -save-temps */
  OPT_save_temps_ = 1162,                    /* -save-temps= */
  OPT_shared = 1163,                         /* -shared */
  OPT_shared_libgcc = 1164,                  /* -shared-libgcc */
  /* OPT_specs = 1165, */                    /* -specs */
  OPT_specs_ = 1166,                         /* -specs= */
  OPT_static = 1167,                         /* -static */
  OPT_static_libasan = 1168,                 /* -static-libasan */
  OPT_static_libgcc = 1169,                  /* -static-libgcc */
  OPT_static_libgcj = 1170,                  /* -static-libgcj */
  OPT_static_libgfortran = 1171,             /* -static-libgfortran */
  OPT_static_libgo = 1172,                   /* -static-libgo */
  OPT_static_libstdc__ = 1173,               /* -static-libstdc++ */
  OPT_static_libtsan = 1174,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1175, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1176, */                /* -std=c++0x */
  OPT_std_c__11 = 1177,                      /* -std=c++11 */
  OPT_std_c__1y = 1178,                      /* -std=c++1y */
  OPT_std_c__98 = 1179,                      /* -std=c++98 */
  OPT_std_c11 = 1180,                        /* -std=c11 */
  /* OPT_std_c1x = 1181, */                  /* -std=c1x */
  /* OPT_std_c89 = 1182, */                  /* -std=c89 */
  OPT_std_c90 = 1183,                        /* -std=c90 */
  OPT_std_c99 = 1184,                        /* -std=c99 */
  /* OPT_std_c9x = 1185, */                  /* -std=c9x */
  OPT_std_f2003 = 1186,                      /* -std=f2003 */
  OPT_std_f2008 = 1187,                      /* -std=f2008 */
  OPT_std_f2008ts = 1188,                    /* -std=f2008ts */
  OPT_std_f95 = 1189,                        /* -std=f95 */
  OPT_std_gnu = 1190,                        /* -std=gnu */
